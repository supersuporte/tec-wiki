...
IS
 ...
 BEGIN
    ...
    FOR nfs IN nfs_cursor LOOP
        ...
        ELSE
            IF data IS NOT NULL THEN
                grava_vendas_liquida_produto(data, TO_NUMBER(cliente, '99999'), produto_grupo, produto_subgrupo, produto_numero, produto_unidade, quantidade_total, valor_total);
            END IF;
 ...
 BEGIN
    ...
    FOR nfs IN nfs_cursor LOOP
        ...
        ELSE
            IF cliente IS NOT NULL THEN
                grava_cutoff_produto(cutoff, TO_NUMBER(cliente, '99999'), produto_grupo, produto_subgrupo, produto_numero, produto_unidade, quantidade_total, valor_total);
            END IF;
 ...
 BEGIN
    ...
    exclui_vendas_liquida_produto(inicio, fim);
    processa_nfs_produto(inicio, fim);
    abate_devolucao_produto(inicio, fim);
    abate_nota_de_credito_produto(inicio, fim);
 ...
 BEGIN
   ...
   IF TO_CHAR(data, 'MM') = '01' then
       processa_nfs_cutoff_anual_prod(data);
   ELSE
